...
--
-- Host: 127.0.0.1
-- Generation Time: 26 Jan 2022 pada 17.00
...
--
-- Database: `db_akademik_0496`
--

-- --------------------------------------------------------

--
-- Struktur dari tabel `tbl_students_0496`
--

CREATE TABLE `tbl_students_0496` (
  `id` int(5) NOT NULL,
...
--
-- Dumping data untuk tabel `tbl_students_0496`
--

INSERT INTO `tbl_students_0496` (`id`, `nim`, `nama`, `jk`, `jurusan`, `alamat`) VALUES
...
--
-- Indexes for table `tbl_students_0496`
--
ALTER TABLE `tbl_students_0496`
  ADD PRIMARY KEY (`id`);
COMMIT;
